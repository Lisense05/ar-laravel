<div id="editUserModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <form id="edit-user-form" action="#" class="relative bg-white rounded-lg shadow dark:bg-gray-700" method="POST">
            @csrf
            @method('PATCH')
            <!-- Modal header -->
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3 flex items-center">
                        <label for="is_admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mr-2">Admin: </label>
                        <input id="is_admin" name="is_admin" type="checkbox" class="w-7 h-7 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    </div>
